  ...
  class Persona {
    ...
    getFriends() {
      ...
      for (var i = 0; i < this.amigos.length; i++) {
        nombreDeAmigos.push(this.amigos[i]["nombre"]);
      }
    ...
    getPromedioEdad() {
      ...
      // Tu código aca:
      var promedioEdadAmigos = 0;
      for (var i = 0; i < this.amigos.length; i++) {
        promedioEdadAmigos = this.amigos[i].edad + promedioEdadAmigos;
      }
      promedioEdadAmigos = promedioEdadAmigos / i;
      return promedioEdadAmigos;
    }
  };
